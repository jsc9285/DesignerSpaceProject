		...
		<div id="innerWrap">
			...
			<div id="myInfoArea">
				<div>
					...
					<div class="profilePic" style="background-image: url(<c:url value='/profileImg/${memberDto.profile_table_stored_name}'/>);"></div>						
					<span class="profileNic">${myMemberDto.member_nick}</span>
					<span>${myMemberDto.member_email}</span>
					<span>${myMemberDto.member_email}</span>
					<span>${myMemberDto.member_comments}</span>
					<span>${myMemberDto.member_cre_date}</span>
