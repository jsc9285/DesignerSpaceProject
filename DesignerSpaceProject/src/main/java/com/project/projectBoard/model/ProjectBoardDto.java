...
public class ProjectBoardDto {
	...
	public ProjectBoardDto(int project_board_no, String project_board_title, String project_board_contents,
			int project_board_views, String project_board_category, Date project_board_cre_date,
	...
	public String toString() {
		return "ProjectBoardDto [project_board_no=" + project_board_no + ", project_board_title=" + project_board_title
				+ ", project_board_contents=" + project_board_contents + ", project_board_views=" + project_board_views
				...
				+ ", PROFILE_TABLE_STORED_NAME=" + PROFILE_TABLE_STORED_NAME + ", project_comment_comments="
